 ...
 * </p>
 * <ul>
 *   <li>{@link navi.navigationRules.impl.MappingsImpl#getMappings <em>Mappings</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MappingsImpl extends MinimalEObjectImpl.Container implements Mappings
{
  ...
  {
    return NavigationRulesPackage.Literals.MAPPINGS;
  }
  ...
  public EList<Mapping> getMappings()
  {
    if (mappings == null)
    {
      mappings = new EObjectContainmentEList<Mapping>(Mapping.class, this, NavigationRulesPackage.MAPPINGS__MAPPINGS);
    }
    return mappings;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case NavigationRulesPackage.MAPPINGS__MAPPINGS:
